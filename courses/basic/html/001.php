...
<head>
    <title>Qlox &mdash; Learning Responsive Design</title>
    ...
    <link rel="stylesheet" href="../../../global/css/class.css">
...
<body>
    ...
    <section id="into" class="mt-3">
        <div class="container text-dark">
            <div class="card card-gexio">
                <div class="card-body">
                    <h5 class="card-title title-intro kelas-title mt-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/">home</a></li>
                                <li class="breadcrumb-item"><a href="/">course</a></li>
                                <li class="breadcrumb-item"><a href="/">Basic HTML</a></li>
                                <li class="breadcrumb-item active" aria-current="page">HTML Document Structure</li>
                            </ol>
                        </nav>
                    </h5>
                </div>
